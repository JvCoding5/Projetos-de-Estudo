...
permitindo incluir placeholders `{}` que serão substituídos por valores especificados.  
"""
...
# Usando o método format para preencher os placeholders
...
print(formato)
# Saída: b=BBBBBB a=AAAAA a=AAAAA c=1.10
